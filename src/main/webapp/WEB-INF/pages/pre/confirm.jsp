...
<body>
				...
				<div id="warp">
					<div>
						...
						<form action="https://www.yeepay.com/app-merchant-proxy/node"
							...
							<input type="hidden" name="hmac" value="${hmac }" /> <input
								type="submit" value="确认支付" />
						</form>
					</div>
				</div>
			</div>
	...
	<!-- elevatezoom -->
	<script src="assets/plugins/elevatezoom/jquery.elevatezoom.js"
