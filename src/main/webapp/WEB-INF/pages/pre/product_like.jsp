...
<body>
                        ...
                        <div class="main">
                            <div class="col-main">
                                ...
                                <section class="shopping-cart">
                                    <div class="page-title margin-buttom-product"><span>购物车</span></div>
                                    <div class="shopping-content padding-30">
                                                    ...
                                                    <tbody>
                                                       ...
                                                       <c:forEach items="products" var="p" varStatus="status">
                                                        <tr>
                                                            ...
                                                            <a href="#?userId=#{userId }&pnum=1">
                                                            <td>
                                                            <button title="Add to Cart" data-placement="top" data-toggle="tooltip" type="button" class="btn btn-button cart-button lagoon-blue-bg"><i class="fa fa-shopping-basket"></i></button>
                                                            </td>
                                                            </a>
                                                        </tr>
                                                        </c:forEach>
                                        ...
                                        <div class="buttons">
                                            <div class="float-right">
                                                ...
                                                <a href="#">总计</a>
                                                <a href="add?orederId=${orderId}&price=${price}">加入购物车</a>
                                ...
                                <div class="col-sm-6 col-md-3 col-lg-3">
                                    ...
                                    <div class="footer-about text-center">
                                        <div class="footer-logo">
                                            <img alt="footer logo" src="staticfile/pre/assets/image/footer-logo.png">
                                        </div>
    ...
    <!-- JS Global -->
    <script src="staticfile/pre/assets/plugins/jquery/jquery-1.11.3.min.js"></script>
    <!-- jquery ui -->
    <script src="staticfile/pre/assets/plugins/jquery-ui-1.12.0/jquery-ui.min.js"></script>
    <!-- bootstarp -->
    <script src="staticfile/pre/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- owl carousel -->
    <script src="staticfile/pre/assets/plugins/owl-carousel/owl.carousel.min.js"></script>
    <!-- nivo slider -->
    <script src="staticfile/pre/assets/plugins/Nivo-Slider/jquery.nivo.slider.js"></script>
    <!-- elevatezoom -->
    <script src="staticfile/pre/assets/plugins/elevatezoom/jquery.elevatezoom.js" type="text/javascript"></script>
    <!-- magnific popup -->
    <script src="staticfile/pre/assets/plugins/magnific/jquery.magnific-popup.min.js"></script>
    <!-- accordion -->
    <script src="staticfile/pre/assets/js/jquery.accordion.source.js"></script>
    <!-- ddslick -->
    <script src="staticfile/pre/assets/js/jquery.ddslick.min.js"></script>
    <!-- custom js -->
    <script src="staticfile/pre/assets/js/theme.js"></script>
