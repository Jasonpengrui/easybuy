#!/bin/bash
##########################################################################################################
#Target Table : dwb.dwb_pg_buffer_rdht__top_history_day
#Source Table : sdf.sdf_pg_buffer_rdht__top_history_day             
#Interface Name : 置顶记录表
...
TARGET_TABLE=dwb_pg_buffer_rdht__top_history_day
#脚本运行开始时间
...
select 
	...
	rank
from
	sdf.sdf_pg_buffer_rdht__top_history_day
where dt='${date}'
"
