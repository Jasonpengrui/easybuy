		...
		<!-- / header menu -->
            ...
            <!-- / breadcrumb -->
                        ...
                        <div class="main">
                            <div class="col-main">
                                ...
                                <section class="shopping-cart">
                                    <div class="page-title margin-buttom-product"><span>我的订单列表</span></div>
                ...
                <c:forEach items="${orders}" var="o" varStatus="status">
					<tr>
						<td class="center"><a
							href="/toview?orderId=${o.orderId}">${o.orderId}</a></td>
						...
						<td class="center"><c:if test="${o.paystate==1}">
								...
								<a href="/toconfirmpay?orderId=${o.orderId}&price=${o.money}"><font color="red">未支付</font></a>
							</c:if></td>
						<td class="center"><fmt:formatDate value="${o.createTime}"
								pattern="yyyy-MM-dd" /></td>
						<td class="center"><span class="input-group-btn">
							<a
							href="/toview?orderId=${o.orderId}" title="查看订单"
							class="link_icon">
                                                            <button  type="button" >
                                                                <i class="fa fa-pencil"></i>
                                                            </button></a>
                            <a
							href="/todelete?orderId=${o.orderId}" title="删除"
							class="link_icon">
