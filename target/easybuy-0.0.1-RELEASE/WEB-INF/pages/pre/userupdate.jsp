	 ...
	 <div class="wrapper">
								...
								<section class="account-login-area ">
									...
									<div class="col-sm-6 col-md-6 col-lg-6 ">
										<div class="new-user-box">
											...
											<div class="new-user-inner" style="width: 700px;padding: 5px 20px 5px 20px; margin-left: 160px;">

												<div class="new-user-content_left" style="float: left; width: 260px;padding: 5px 20px 5px 20px;">
													<span class="account-title">信息更改</span>
													...
													<div class="form-group">
														...
														<input type="text" name="username" value="${username}" placeholder="username" id="input-email" class="form-control" readonly="readonly">
													...
													<div class="form-group">
														<label class="control-label" for="input-password">邮箱 <span><em>*</em></span></label>
														<input type="email" name="user.userInfo.email" value="${user.userInfo.email}" placeholder="email" id="input-password" class="form-control">

													</div>
													<div class="right">
														<div class="form-group">
															<label class="control-label" for="input-password">电话 <span><em>*</em></span></label>
															<input type="text" name="user.userInfo.telephone" value="${user.userInfo.telephone}" placeholder="tel" id="tel" class="form-control">

														</div>

														<div class="form-group">
															<label class="control-label" for="input-password">地址 <span><em>*</em></span></label>
															<input type="text" name="user.userInfo.address" value="${user.userInfo.address}" placeholder="address" id="tel" class="form-control">
												...
												<div class="new-user-content_right" style=" width: 260px; float: right; padding: 5px 20px 5px 20px;">
													<span class="account-title"></span>
													<p class="select-text"></p>

													<div class="form-group">
														<label class="control-label" for="input-birthday">生日<span><em>*</em></span></label>
														<input type="date" name="user.userInfo.birthday" value='<fmt:formatDate value="${user.userInfo.birthday }" pattern="yyyy-MM-dd"/>' placeholder="tel" id="tel" class="form-control">
											...
											<div style="padding-top: 50px; text-align: center; margin-left: 400px;">
												<span class="item_name" style="width:12px; padding-left: 30px;"></span>
												<a href="#" class="link_btn" onclick="formSubmit('userupdate','_self');this.blur();">保存</a>
		...
		<footer class="footer-area padding-45">
						...
						<div class="col-sm-6 col-md-3 col-lg-3">
							...
							<div class="footer-about text-center">
								<div class="footer-logo">
									<img alt="footer logo" src="assets/image/footer-logo.png">
								</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<p class="copyright">Copyright &copy; 2017.公司名称版权所有
						<a target="_blank" href="#">&#x7F51;&#x9875;&#x6A21;&#x677F;</a>
					</p>
				</div>
			</div>
			<!-- / footer bottom -->
