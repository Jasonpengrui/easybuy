		...
		<!-- / header menu -->
                        ...
                        <div class="main">
                            <div class="col-main">
                                ...
                                <section class="shopping-cart">
                                    <div class="page-title margin-buttom-product"><span>我的订单详情</span></div>
			...
			<table class="cart-table data-table">
				...
				<c:forEach items="${orderitems}" var="oit">
					<tr>
						<td class="center"><img src="${app}/staticfile/images/${oit.product.page}" width="50"
							height="50" /></td>
						...
						<td class="center"><strong class="rmb_icon">${oit.product.price*oit.buynum }</strong></td>
                                        ...
                                        <div class="buttons">
                                            <div class="float-right">
                                                <a class="btn btn-button global-bg white" href="#">TOTAL: $${o.money}</a>
                                            </div>
                                        </div>
                                    </div>
