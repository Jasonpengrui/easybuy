                                            ...
                                            <div class="new-user-box">
                                                ...
                                                <div class="new-user-inner">
                                                    <div class="new-user-content">
                                                        <span class="account-title">账户注册</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" name="userInfo.email"  placeholder="email" id="input-password" class="form-control">
	                                           
                                                        </div>

                                                         <div class="form-group">
                                                            <label class="control-label" for="input-password">电话 <span><em>*</em></span></label>
                                                            <input type="text" name="userInfo.telephone"  placeholder="tel" id="tel" class="form-control">
	                                           
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label" for="input-password">备注 <span><em>*</em></span></label>
                                                            <textarea placeholder="备注" class="textarea"  style="height:100px;width:450px;"></textarea>
	                                                   ...
	                                                   <div>
												        ...
												        <a href="#" class="link_btn"  onclick="formSubmit('/regist','_self');this.blur();">保存</a>
